...
1. Click the green **Code** button → **Download ZIP** → unzip on your laptop
2. Open `code/1000_synth.Rmd` in RStudio
3. Make sure you have the required packages installed (see pre-summit email)
...
## Required R Packages
```r
install.packages(c("tidyverse", "tidysynth", "zoo", "knitr", "kableExtra", "here"))
```
